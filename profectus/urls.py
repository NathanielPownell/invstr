...
urlpatterns = [
    ...
    path('aboutapp/', web_app_views.aboutapp, name='aboutapp'),
    path('aboutme/', web_app_views.aboutme, name='aboutme'),
    path('dashboard/', web_app_views.dashboard, name='dashboard'),
    path('trade/', web_app_views.trade, name='trade'),
    path('', include('web_app.urls')),
    path('dash/', include('investr.urls'), name='dash'),
